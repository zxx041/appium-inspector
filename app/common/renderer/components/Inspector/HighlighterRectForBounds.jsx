 ...
 */
const HighlighterRectForBounds = ({elSize, elLocation, scaleRatio, heightScaleRatio, xOffset}) => (
  <div
    ...
    style={{
      ...
      top: elLocation.y / heightScaleRatio,
      width: elSize.width / scaleRatio,
      height: elSize.height / heightScaleRatio,
    }}
  >
    <div></div>
  </div>
